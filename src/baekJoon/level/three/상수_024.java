 ...
 * 상근이는 세자리 숫자 두 개를 칠판에 써주었다. 그 다음에 크기가 큰 수를 말해보라고 했다.
 * 
 ...
 * 
 * 입력 : 첫째 줄에 상근이가 칠판에 적은 두 수 A와 B가 주어진다. 두 수는 같지 않은 세 자리수이며, 0이 포함되어 있지 않다.
...
public class 상수_024 {
	public static void main(String[] args) {
		...
		num1 = Integer.parseInt(reverseString(s1));
		num2 = Integer.parseInt(reverseString(s2));
